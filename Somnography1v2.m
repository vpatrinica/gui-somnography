function varargout = Somnography1v2(varargin)
% SOMNOGRAPHY1V2 M-file for Somnography1v2.fig
%      SOMNOGRAPHY1V2, by itself, creates a new SOMNOGRAPHY1V2 or raises the existing
%      singleton*.
%
%      H = SOMNOGRAPHY1V2 returns the handle to a new SOMNOGRAPHY1V2 or the handle to
%      the existing singleton*.
%
%      SOMNOGRAPHY1V2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SOMNOGRAPHY1V2.M with the given input arguments.
%
%      SOMNOGRAPHY1V2('Property','Value',...) creates a new SOMNOGRAPHY1V2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Somnography1v2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Somnography1v2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Somnography1v2

% Last Modified by GUIDE v2.5 16-Mar-2012 21:29:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Somnography1v2_OpeningFcn, ...
                   'gui_OutputFcn',  @Somnography1v2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Somnography1v2 is made visible.
function Somnography1v2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Somnography1v2 (see VARARGIN)

% Choose default command line output for Somnography1v2
...
% UIWAIT makes Somnography1v2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Somnography1v2_OutputFcn(hObject, eventdata, handles)
...
if ~isequal(file, 0)
    ...
    set(handles.FileMenu, 'Userdata', strrep(fullfile(path, file), '.mat', '_out_v2.mat'))
...
% save the processed info into a file...
 outputData = [num2cell([processData{:, 6}]') outputData];
